    ...
    <footer class="bg-gradient-to-b from-gray-800 to-gray-900 text-white pt-12 pb-6">
      <div class="container mx-auto px-6 md:px-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">
          <p>© ${new Date().getFullYear()} ezInvoice. All Rights Reserved</p>
          <div class="mt-4 md:mt-0">
            <a href="#" class="text-gray-400 hover:text-white transition-colors duration-300 mr-4">Sitemap</a>
...
function insertFooter() {
  ...
  if (window.APP_CONSTANTS) {
    const updateLink = (id, url, defaultUrl) => {
    ...
    updateLink('appstore-footer', APP_CONSTANTS.IOS_APP);
  }
}
